...
| `UI.js`       | `src/core/UI/html.js`  | Zero-dependency template engine using JavaScript tagged template literals. `html` creates a template object; `render(template, element)` writes it to the DOM. No Virtual DOM, no JSX. |
