...
2. AI writes:
   - content/posts/published/YYYY/MM/DD/XX/YY/en.md  ← body; optional YAML frontmatter at top for locale overrides
   - content/posts/published/YYYY/MM/DD/XX/YY/meta.yaml
...
5. Article live at /{YYYYMMDD}/{cat1}/{cat2}/{slug}/{locale}/
...
```text
✅ AI Agent writes meta.yaml + <locale>.md to content/posts/published/YYYY/MM/DD/XX/YY/
