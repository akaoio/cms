...
export class Router {
     ...
     *
     * @example
     * // Route patterns from /build/routes.json: "/[category]/[slug]", "/tag/[tag]"
     * process({ path: "/vi/the-thao/bai-viet-abc" })
     * // => { locale: {code: "vi", ...}, params: { category: "the-thao", slug: "bai-viet-abc" }, route: "/[category]/[slug]", path: "/vi/the-thao/bai-viet-abc/" }
     *
     * process({ path: "/en/tag/football" })
     * // => { locale: {code: "en", ...}, params: { tag: "football" }, route: "/tag/[tag]", path: "/en/tag/football/" }
     *
     * process({ path: "/" })
     ...
     *
     * @example
     * match(["the-thao", "bai-viet-abc"], "/[category]/[slug]")
     * // => { category: "the-thao", slug: "bai-viet-abc" }
     *
     * match(["tag", "football"], "/tag/[tag]")
     * // => { tag: "football" }
     *
     * match(["about"], "/[category]/[slug]")
     * // => null (no match)
     */
